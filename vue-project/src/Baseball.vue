    ...
    async getPitcherList(teamId) {
      try {
        ...
        if (error.response) {
          ...
          alert("ピッチャーの取得に失敗しました: サーバーに接続できませんでした。");
        }
      }
    },
    async getBatterList(teamId) {
      try {
        ...
        if (error.response) {
          ...
          alert("バッターの取得に失敗しました: サーバーに接続できませんでした。");
        }
      }
    },
    async matchResultSearch(pitcherId, batterId) {
      try {
        ...
        if (error.response) {
          ...
          alert("対戦結果の取得に失敗しました: サーバーに接続できませんでした。");
        }
      }
    },
  },
